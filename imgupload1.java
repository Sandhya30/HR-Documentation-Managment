...
import static Efficient.imgupload.UPLOAD_DIR;
...
@WebServlet("/imgupload1")
public class imgupload1 extends HttpServlet {
    /*
    ...
    String languages = request.getParameter("languages");
     String exp = request.getParameter("exp");
        ...
        try {
            ...
            PreparedStatement pst = con.prepareStatement("update request set file1='"+imgname+"',fpath='"+imgpath+"' where username='"+username+"' and hr='"+hr+"' ");
            
           // pst.setInt(1, id);
          
            pst.executeUpdate();
            response.sendRedirect("req2.jsp?hr="+hr);
        } catch (Exception e) {
            out.println(e);
        }
